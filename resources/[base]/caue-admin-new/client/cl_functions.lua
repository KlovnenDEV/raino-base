...
function RefreshMenu(Type)
	if Type == "Favorites" then
		-- Favorites
		if
			GetResourceKvpString("varial-adminmenu-favorites") == nil
			or GetResourceKvpString("varial-adminmenu-favorites") == "[]"
		then
	...
	elseif Type == "Targets" then
		if
			GetResourceKvpString("varial-adminmenu-pinned_targets") == nil
			or GetResourceKvpString("varial-adminmenu-pinned_targets") == "[]"
		then
	...
	elseif Type == "Settings" then
		if
			GetResourceKvpString("varial-adminmenu-settings") == nil
			or GetResourceKvpString("varial-adminmenu-settings") == "[]"
		then
